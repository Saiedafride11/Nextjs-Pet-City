      ...
      <main>
        ...
        <section className="w-11/12 grid grid-cols-3 gap-4 mx-auto my-10">
          <div className="col-span-3 md:col-span-2 bottom-1 dark:bg-slate-900 border-cyan-100 py-4 px-6 md:py-10 md:px-12 shadow-md rounded-sm">
            <div>
              <h2 className="mb-4 text-xl dark:text-white font-bold">
                DESCTIPION
              </h2>
            ...
            <div className="mt-12 mb-6 flex items-center ml-8">
              ...
              <a
                className="ml-3 text-lg dark:text-gray-400 hover:text-blue-500 dark:hover:text-blue-500"
                href="#"
              >
                <FaFacebookF />
              </a>
              <a
                className="ml-3 text-xl dark:text-gray-400 hover:text-blue-500 dark:hover:text-blue-500"
                href="#"
              >
                <AiOutlineTwitter />
              </a>
              ...
              <a
                className="ml-3 text-lg dark:text-gray-400 hover:text-red-500 dark:hover:text-red-500"
                href="#"
              >
                <IoLogoGoogleplus />
              </a>
            ...
            <div>
              ...
              <div className="text-center pt-8 pb-12">
                <img
                  ...
                  alt="ImageLogo"
                />
                <h2 className="my-4 font-semibold font-sans dark:text-white">
                  Pay Walt
                </h2>
